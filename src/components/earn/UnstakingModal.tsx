      ...
      {!attempting && !hash && (
        <ContentWrapper gap="lg">
          ...
          <TYPE.subHeader style={{ textAlign: 'center' }}>
            When you withdraw, your BDS is claimed and your liquidity is removed from the mining pool.
          </TYPE.subHeader>
      ...
      {attempting && !hash && (
        <LoadingView onDismiss={wrappedOndismiss}>
          <AutoColumn gap="12px" justify={'center'}>
            ...
            <TYPE.body fontSize={20}>Claiming {stakingInfo?.earnedAmount?.toSignificant(4)} BDS</TYPE.body>
          </AutoColumn>
        </LoadingView>
      )}
      {hash && (
