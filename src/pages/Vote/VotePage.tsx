...
import { PROPOSAL_LENGTH_IN_DAYS, COMMON_CONTRACT_NAMES, BDS, ZERO_ADDRESS } from '../../constants'
      ...
      <ProposalInfo gap="lg" justify="start">
        ...
        <AutoColumn gap="10px" style={{ width: '100%' }}>
          ...
          {proposalData && proposalData.status === 'active' && !showVotingButtons && (
            <GreyCard>
              <TYPE.black>
                Only BDS votes that were self delegated or delegated to another address before block{' '}
