...
const BRIDGE_MINER_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  '128': '0x65b3AE390B3531cf94b8bE3f735F72752c5d3BF9',
  '256': '0x65b3AE390B3531cf94b8bE3f735F72752c5d3BF9',
}
const BRIDGE_TOKEN_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.KOVAN]: '0x0A3B082C1ceDa3d35E5baD2776c5a5236044A03D',
    ['128']: '0x3Bb87041edF93EaEA82F47F2B495E5859085E3eE',
  ['256']: '0x3Bb87041edF93EaEA82F47F2B495E5859085E3eE',
}
const HIVE_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.KOVAN]: '0xA45b10Df50D6d0Bb4733Dd54E52fB4CefEc34E38',
    ['128']: '0xAfa6C39FDf16446078aEeEE53E4c4843811570A1',
  ['256']: '0xAfa6C39FDf16446078aEeEE53E4c4843811570A1',
}
